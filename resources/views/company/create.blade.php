...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white pl-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Register Your Company</li>
        </ol>
    </nav>
</div>
        ...
        <div class="col-md-5">
            <div class="card card-default mt-4 shadow">
                <div class="card-header">
                    <h5><b>{{ __('Create Your Company Account') }}</b></h4>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('company.account.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address')}}" id="address" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone')}}" id="phone" required>
