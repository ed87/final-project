...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white pl-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">University Admin User Account Settings</li>
        </ol>
    </nav>
</div>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-5">
            <div class="card card-default mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.user-account.update', $user->id) }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                <button type="submit" class="btn btn-block btn-primary">
                                    {{ __('Update Admin User Account Details') }}
                                </button>
                            </div>
                        </div>
                    </form>
